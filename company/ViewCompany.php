...
<meta charset="utf-8" />
<head>
<link rel="stylesheet" type="text/css" href="/eqc/css/view.css" />
...
///////////////////////////////////////////////////////////////
           ...
           mysqli_close($conn);
            ...
            if(isset($_POST['viewDetails'])){
              header("location: ./viewCompanyDetails.php?id=".$rowID."&id2=".$row_HrName."");
          }

          if(isset($_POST['edit'])){
            header("location: ./editCompany.php?id=".$rowID."");
        }
